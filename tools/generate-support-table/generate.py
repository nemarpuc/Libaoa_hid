...
ROWS = (
    ...
    Presentation("joystick", "Gamepad: Joystick application", "conditional", "Caller-declared axes and target mappings; Android classification requires target evidence"),
    ...
    Presentation("touchpad-fixed-mt", "Touchscreen: Touchpad application", "conditional", "Classification and gestures vary by release/OEM"),
